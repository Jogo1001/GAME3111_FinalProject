...
void BlendApp::BuildDoorGeometry()
{
	GeometryGenerator geoGen;
...
void BlendApp::BuildConeGeometry()
{
	GeometryGenerator geoGen;
	GeometryGenerator::MeshData cone = geoGen.CreateCone(2.0f, 4.0f, 20, 10); // Bottom radius = 1.0f, Height = 2.0f, Slices = 20, Stacks = 10
...
{
	GeometryGenerator geoGen;
	GeometryGenerator::MeshData cylinder = geoGen.CreateCylinder(2.0f, 2.0f, 8.0f, 20, 10); // Bottom radius = 1.0f, Top radius = 1.0f, Height = 2.0f, Slices = 20, Stacks = 10
...
void BlendApp::BuildPyramidGeometry()
{
	GeometryGenerator geoGen;
	GeometryGenerator::MeshData pyramid = geoGen.CreatePyramid(15.0f, 10.0f); // Base width = 2.0f, Height = 3.0f
...
void BlendApp::BuildWedgeGeometry()
{
	GeometryGenerator geoGen;
	GeometryGenerator::MeshData wedge = geoGen.CreateWedge(0.5f, 5.0f, 5.0f); // Width = 2.0f, Height = 2.0f, Depth = 2.0f
...
{
	GeometryGenerator geoGen;
	GeometryGenerator::MeshData torus = geoGen.CreateTorus(1.0f, 0.3f, 20, 20); // Radius = 1.0f, Tube radius = 0.3f, Slices = 20, Stacks = 20
...
void BlendApp::BuildRenderItems()
{
	...
	XMStoreFloat4x4(&wavesRitem->World, XMMatrixTranslation(0.0f, -0.8f, 0.0f));
	...
	coneRitem->ObjCBIndex = 4; // Unique object constant buffer index
	coneRitem->Mat = mMaterials["wirefence"].get(); // Use the "bricks" material (or any other material)
	...
	coneRitem2->ObjCBIndex = 5; // Unique object constant buffer index
	coneRitem2->Mat = mMaterials["wirefence"].get(); // Use the "bricks" material (or any other material)
	...
	coneRitem3->ObjCBIndex = 6; // Unique object constant buffer index
	coneRitem3->Mat = mMaterials["wirefence"].get(); // Use the "bricks" material (or any other material)
	...
	XMStoreFloat4x4(&coneRitem4->World, XMMatrixTranslation(-7.0f, 10.0f, -7.0f)); // Position the cone at (3, 1, 0)
	coneRitem4->ObjCBIndex = 7; // Unique object constant buffer index
	coneRitem4->Mat = mMaterials["wirefence"].get(); // Use the "bricks" material (or any other material)
	...
	XMStoreFloat4x4(&cylinderRitem->World, XMMatrixTranslation(7.0f, 4.0f, 7.0f)); // Position the cylinder at (0, 1, 0)
	cylinderRitem->ObjCBIndex = 8; // Unique object constant buffer index
	cylinderRitem->Mat = mMaterials["bricks"].get(); // Use the "bricks" material (or any other material)
	...
	XMStoreFloat4x4(&cylinderRitem2->World, XMMatrixTranslation(-7.0f, 4.0f, 7.0f)); // Position the cylinder at (0, 1, 0)
	cylinderRitem2->ObjCBIndex = 9; // Unique object constant buffer index
	cylinderRitem2->Mat = mMaterials["bricks"].get(); // Use the "bricks" material (or any other material)
	...
	XMStoreFloat4x4(&cylinderRitem3->World, XMMatrixTranslation(-7.0f, 4.0f, -7.0f)); // Position the cylinder at (0, 1, 0)
	cylinderRitem3->ObjCBIndex = 10; // Unique object constant buffer index
	cylinderRitem3->Mat = mMaterials["bricks"].get(); // Use the "bricks" material (or any other material)
	...
	XMStoreFloat4x4(&cylinderRitem4->World, XMMatrixTranslation(7.0f, 4.0f, -7.0f)); // Position the cylinder at (0, 1, 0)
	cylinderRitem4->ObjCBIndex = 11; // Unique object constant buffer index
	cylinderRitem4->Mat = mMaterials["bricks"].get(); // Use the "bricks" material (or any other material)
	...
	XMStoreFloat4x4(&pyramidRitem->World, XMMatrixTranslation(0.0f, 13.0f, 0.0f)); // Position the pyramid at (0, 1, 0)
	pyramidRitem->ObjCBIndex = 12; // Unique object constant buffer index
	pyramidRitem->Mat = mMaterials["bricks"].get(); // Use the "stone" material (or any other material)
	...
	XMMATRIX rotation = XMMatrixRotationY(XMConvertToRadians(180.0f)); // Rotate 45 degrees around Y-axis
	...
	wedgeRitem->Mat = mMaterials["bricks"].get();
	...
	XMMATRIX rotation2 = XMMatrixRotationY(XMConvertToRadians(180.0f)); // Rotate 45 degrees around Y-axis
	...
	wedgeRitem2->ObjCBIndex = 14;
	wedgeRitem2->Mat = mMaterials["bricks"].get();
	...
	XMStoreFloat4x4(&torusRitem->World, XMMatrixTranslation(0.0f, 19.0f, 0.0f)); // Position the torus at (0, 5, 0)
	torusRitem->ObjCBIndex = 15; // Unique object constant buffer index
	torusRitem->Mat = mMaterials["bricks"].get(); // Use the "bricks" material (or any other material)
